...
def app():
    ...
    region = st.text_input('Enter area region of NYC the property is located in', 'Bronx')
...
0.499402,0.097345,0.000478,0.218608,0.019373,0.010883,0.018775,0.111337,0.119540,0.001942,0.001681,0.107027,latitude,longitude, 0.145783, 0.105869]
    ...
    result = loaded_model.predict(x) # próba - potem sie usunie i zamieni wynikiem z modelu

    price = st.text(f"Predicted price of your real estate is: {result}")
